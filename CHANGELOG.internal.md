...
- Updated `@anthropic-ai/claude-agent-sdk` to v0.2.56 and `@anthropic-ai/sdk` to v0.78.0 across `cyrus-core`, `cyrus-claude-runner`, and `cyrus-simple-agent-runner`. Closed superseded PR #897 (CYPACK-844) and cancelled CYPACK-844. ([CYPACK-847](https://linear.app/ceedar/issue/CYPACK-847), [#899](https://github.com/ceedaragents/cyrus/pull/899))
