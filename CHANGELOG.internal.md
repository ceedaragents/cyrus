...
### Changed
- Updated `@anthropic-ai/claude-agent-sdk` from 0.2.7 to 0.2.31 and `@anthropic-ai/sdk` from 0.71.2 to 0.72.1. Added required `stop_reason` field to `GeminiRunner` and adapters to maintain compatibility with new SDK result message types. ([CYPACK-781](https://linear.app/ceedar/issue/CYPACK-781), [#831](https://github.com/ceedaragents/cyrus/pull/831))
