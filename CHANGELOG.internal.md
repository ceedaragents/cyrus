...
### Added
- Verified Linear MCP and cyrus-tools MCP access from agent sessions (get_issue, list_teams, get_child_issues, get_agent_sessions, create_comment). ([CYPACK-825](https://linear.app/ceedar/issue/CYPACK-825), [#877](https://github.com/ceedaragents/cyrus/pull/877))
