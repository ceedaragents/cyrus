...
### Changed
- Updated `@anthropic-ai/claude-agent-sdk` from 0.2.7 to 0.2.31 and `@anthropic-ai/sdk` from 0.71.2 to 0.72.1, bringing 24 new SDK versions with improvements including stop reason tracking, debug logging control, PDF page range support, MCP tool annotations, and structured outputs fixes. See the [claude-agent-sdk changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#0231) for full details. ([CYPACK-783](https://linear.app/ceedar/issue/CYPACK-783), [#833](https://github.com/ceedaragents/cyrus/pull/833))
- Added required `stop_reason` field to `GeminiRunner` result messages to maintain compatibility with updated SDK types ([CYPACK-783](https://linear.app/ceedar/issue/CYPACK-783), [#833](https://github.com/ceedaragents/cyrus/pull/833))
