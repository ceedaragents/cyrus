...
### Changed
- Updated `@anthropic-ai/claude-agent-sdk` from v0.2.7 to v0.2.29 (22 versions) and `@anthropic-ai/sdk` from v0.71.2 to v0.72.1 across `cyrus-core`, `cyrus-claude-runner`, and `cyrus-simple-agent-runner` packages. Brings Claude Code v2.1.29 parity and latest SDK improvements. ([CYPACK-780](https://linear.app/ceedar/issue/CYPACK-780), [#830](https://github.com/ceedaragents/cyrus/pull/830))
