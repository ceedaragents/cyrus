...
Linear will redirect back to Cyrus and you'll see "Authorization successful!" in your browser. The tokens are saved to your config.
...
This clones the repository to `~/.cyrus/repos/` and adds it to your config with the Linear workspace credentials from Step 6.
