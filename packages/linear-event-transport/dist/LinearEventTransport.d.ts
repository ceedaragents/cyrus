 ...
 */
export declare class LinearEventTransport extends EventEmitter implements ApplicationModule {
    private webhookPath;
     ...
     */
    handleRequest(req: IncomingMessage, res: ServerResponse, _url: URL): Promise<void>;
    /**
