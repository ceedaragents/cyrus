...
import type { LinearWebhookClientConfig, LinearWebhookClientEvents, StatusUpdate } from "./types.js";
export declare interface LinearWebhookClient {
    on<K extends keyof LinearWebhookClientEvents>(event: K, listener: LinearWebhookClientEvents[K]): this;
    emit<K extends keyof LinearWebhookClientEvents>(event: K, ...args: Parameters<LinearWebhookClientEvents[K]>): boolean;
}
/**
