 ...
 */
export function translateWebhookToWorkItem(webhook) {
 ...
 */
function translateIssueAssignedWebhook(webhook) {
 ...
 */
function translateIssueCommentMentionWebhook(webhook) {
	const { notification } = webhook;
 ...
 */
function translateIssueNewCommentWebhook(webhook) {
	const { notification } = webhook;
 ...
 */
function translateAgentSessionCreatedWebhook(webhook) {
 ...
 */
function translateAgentSessionPromptedWebhook(webhook) {
 ...
 */
export function translateActivityToLinear(activity, agentSessionId) {
 ...
 */
function translateActivityContent(activity) {
 ...
 */
function formatToolResult(tool, output) {
 ...
 */
export function translateWorkItemUpdate(update) {
	const result = {};
