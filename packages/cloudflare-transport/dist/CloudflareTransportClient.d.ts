...
import type { CloudflareTransportConfig, CloudflareTransportEvents } from "./types.js";
export declare interface CloudflareTransportClient {
    on<K extends keyof CloudflareTransportEvents>(event: K, listener: CloudflareTransportEvents[K]): this;
    emit<K extends keyof CloudflareTransportEvents>(event: K, ...args: Parameters<CloudflareTransportEvents[K]>): boolean;
}
/**
