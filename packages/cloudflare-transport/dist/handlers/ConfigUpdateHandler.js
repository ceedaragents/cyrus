...
export class ConfigUpdateHandler extends EventEmitter {
     ...
     */
    async handleGitHubCredentials(req, body) {
        try {
     ...
     */
    async handleLinearCredentials(req, body) {
        try {
            const credentials = JSON.parse(body);
            // Validate required fields
     ...
     */
    async handleClaudeApiKey(req, body) {
        try {
     ...
     */
    async handleRepositories(req, body) {
        try {
     ...
     */
    async handleGetConfig(req, body) {
        try {
