...
export declare class ConfigUpdateHandler extends EventEmitter {
     ...
     */
    handleGitHubCredentials(req: IncomingMessage, body: string): Promise<HandlerResult>;
    /**
     * Handle Linear credentials update
     */
    handleLinearCredentials(req: IncomingMessage, body: string): Promise<HandlerResult>;
    /**
     * Handle Claude API key update
     */
    handleClaudeApiKey(req: IncomingMessage, body: string): Promise<HandlerResult>;
    /**
     * Handle repositories configuration update
     */
    handleRepositories(req: IncomingMessage, body: string): Promise<HandlerResult>;
    /**
