import type { ApiResponse, ConfigureMcpPayload, CyrusConfigPayload, CyrusEnvPayload, RepositoryPayload, TestMcpPayload } from "./types.js";
/**
...
export declare class ConfigUpdater {
     ...
     */
    applyConfig(config?: CyrusConfigPayload, env?: CyrusEnvPayload, mcp?: ConfigureMcpPayload): Promise<ApiResponse[]>;
    /**
