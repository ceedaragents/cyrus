...
### Added
- **Slack MCP server integration** - Agent sessions now have access to Slack tools (search messages, send messages, read channels, manage canvases, look up users) when the `SLACK_MCP_TOKEN` environment variable is set. ([CYPACK-828](https://linear.app/ceedar/issue/CYPACK-828), [#881](https://github.com/ceedaragents/cyrus/pull/881))
