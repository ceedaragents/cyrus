...
### Changed
- **Updated Anthropic SDKs** - Updated `@anthropic-ai/claude-agent-sdk` from v0.1.72 to v0.1.76 ([changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#0174)). Changes include parity with Claude Code v2.0.74 and improved Stop hook reliability. The `@anthropic-ai/sdk` remains at v0.71.2 (already latest). ([CYPACK-683](https://linear.app/ceedar/issue/CYPACK-683))
