...
### Changed
- **Updated Claude SDK dependencies** - Updated `@anthropic-ai/claude-agent-sdk` to v0.2.45 and `@anthropic-ai/sdk` to v0.76.0. See [claude-agent-sdk changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#v0245) for details. ([CYPACK-819](https://linear.app/ceedar/issue/CYPACK-819), [#871](https://github.com/ceedaragents/cyrus/pull/871))
