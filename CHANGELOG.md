...
### Changed
- **Updated `@anthropic-ai/claude-agent-sdk` to v0.2.123 and `@anthropic-ai/sdk` to v0.91.0** — Bumps the bundled Claude Code binary from v2.1.117 to v2.1.123 (parity releases). Also removes `LSP` from `availableTools` — the tool is no longer emitted by Claude Code's init block as of SDK v0.2.121. See [SDK changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md) for details. ([CYPACK-1148](https://linear.app/ceedar/issue/CYPACK-1148))
