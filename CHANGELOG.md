...
- Updated `@anthropic-ai/claude-agent-sdk` from v0.1.72 to v0.1.76 to maintain parity with Claude Code v2.0.76. This update includes fixes to Stop hook reliability and other improvements. See the [Claude Agent SDK changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md) for full details. ([CYPACK-660](https://linear.app/ceedar/issue/CYPACK-660))
