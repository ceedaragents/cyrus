...
### Changed
- Updated @anthropic-ai/claude-agent-sdk from v0.1.42 to v0.1.50 - includes structured outputs support, Azure AI Foundry support, and parity updates with Claude Code v2.0.50 - see [@anthropic-ai/claude-agent-sdk v0.1.50 changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#0150) (CYPACK-421)
- Updated @anthropic-ai/sdk from v0.69.0 to v0.70.1 - adds Foundry SDK and fixes for structured outputs beta - see [@anthropic-ai/sdk v0.70.1 changelog](https://github.com/anthropics/anthropic-sdk-typescript/blob/main/CHANGELOG.md#0701-2025-11-20) (CYPACK-421)
