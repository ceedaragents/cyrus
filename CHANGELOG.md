...
- **Major new feature: Cursor agent harness support** - Cyrus now supports Cursor as a first-class agent option. Issues tagged with `[agent=cursor]` run end-to-end with the Cursor runner and post final response activity in validated F1 workflows. ([CYPACK-804](https://linear.app/ceedar/issue/CYPACK-804), [#858](https://github.com/ceedaragents/cyrus/pull/858))
