...
### Added
- **User elicitation for agent interactions** - Cyrus can now present users with questions and options to select from directly in Linear. When working on tasks that require user input (yes/no confirmations, multiple choice selections, or decision points), Cyrus will pause and wait for your response before continuing. ([CYPACK-553](https://linear.app/ceedar/issue/CYPACK-553))
