...
### Changed
- **Updated Claude SDK dependencies** - Updated `@anthropic-ai/claude-agent-sdk` to v0.2.39 and `@anthropic-ai/sdk` to v0.74.0. See [claude-agent-sdk v0.2.39 changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#v0239) for details. ([CYPACK-802](https://linear.app/ceedar/issue/CYPACK-802), [#856](https://github.com/ceedaragents/cyrus/pull/856))
