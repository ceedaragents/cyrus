...
### Dependencies
- **Updated Claude Agent SDK** - Updated `@anthropic-ai/claude-agent-sdk` from 0.2.7 to 0.2.17, bringing notification hook support, `close()` method for Query interface, and parity with Claude Code v2.1.17. See [Claude Agent SDK changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#0217-2026-01-23) for full details. ([CYPACK-750](https://linear.app/ceedar/issue/CYPACK-750), [#795](https://github.com/ceedaragents/cyrus/pull/795))
