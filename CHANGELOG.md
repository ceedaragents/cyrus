...
- Updated `@anthropic-ai/claude-agent-sdk` from v0.1.72 to v0.1.75 to maintain parity with Claude Code v2.0.75. This update includes fixes to Stop hooks to run more consistently (previously could fail with `Stream closed` error). See the [Claude Agent SDK changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md) for full details. ([CYPACK-657](https://linear.app/ceedar/issue/CYPACK-657))
