...
- **PR Guard Stop hook** — Automatically ensures pull requests are created when code changes exist before the agent completes, preventing sessions from ending without shipping. ([CYPACK-991](https://linear.app/ceedar/issue/CYPACK-991), [#1017](https://github.com/ceedaragents/cyrus/pull/1017))
- **Custom skills** — Users can add custom skill files to their repository (`.claude/skills/`) or globally (`~/.cyrus/skills/`) to customize agent workflow behavior. Repository skills override global, which override defaults. ([CYPACK-991](https://linear.app/ceedar/issue/CYPACK-991), [#1017](https://github.com/ceedaragents/cyrus/pull/1017))
