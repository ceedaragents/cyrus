...
- Updated @anthropic-ai/claude-agent-sdk from v0.1.26 to v0.1.27 - includes parity update with Claude Code v2.0.27 and new plugins field for extended functionality. See [@anthropic-ai/claude-agent-sdk v0.1.27 changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#0127)
