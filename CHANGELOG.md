...
### Changed
- Slack bot token is now read exclusively from the `SLACK_BOT_TOKEN` environment variable, and Slack agent sessions now have access to Linear and cyrus-tools MCP servers for issue management. ([CYPACK-824](https://linear.app/ceedar/issue/CYPACK-824), [#876](https://github.com/ceedaragents/cyrus/pull/876))
