...
- Auto-generated ~/.gemini/settings.json with single-turn model aliases (e.g., gemini-2.5-flash-shortone) and preview features enabled
...
- Summary subroutines now use `singleTurn` mode with Gemini's "-shortone" model aliases for consistent single-turn behavior
