...
### Changed
- Updated `@anthropic-ai/claude-agent-sdk` from `0.3.205` to [`0.3.238`](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#03238) and `@anthropic-ai/sdk` from `^0.110.0` to [`^0.120.0`](https://github.com/anthropics/anthropic-sdk-typescript/blob/main/CHANGELOG.md#01200-2026-08-19), restoring `LSP`, adding `ShareOnboardingGuide`, and bringing Claude sessions current with the latest Agent SDK and API capabilities. ([CYPACK-1457](https://linear.app/ceedar/issue/CYPACK-1457/update-anthropic-aiclaude-agent-sdk-and-anthropic-aisdk-to-the-latest), [#1420](https://github.com/cyrusagents/cyrus/pull/1420))
