...
### Changed
- **Updated Claude SDK dependencies** - Updated `@anthropic-ai/claude-agent-sdk` to v0.2.42 and `@anthropic-ai/sdk` to v0.74.0. See [claude-agent-sdk v0.2.42 changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#v0242) for details. ([CYPACK-808](https://linear.app/ceedar/issue/CYPACK-808), [#863](https://github.com/ceedaragents/cyrus/pull/863))
