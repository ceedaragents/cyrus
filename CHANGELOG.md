...
- **Updated dependencies** - Updated `@anthropic-ai/claude-agent-sdk` to 0.2.3 ([v0.2.3 changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#023-2026-01-09)) for parity with Claude Code v2.1.3. Updated `zod` from 3.x to 4.3.5 to satisfy peer dependencies. Migrated from `zod-to-json-schema` to Zod v4's native `toJSONSchema()` method. ([CYPACK-700](https://linear.app/ceedar/issue/CYPACK-700), [CYPACK-704](https://linear.app/ceedar/issue/CYPACK-704))
