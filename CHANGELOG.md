...
### Changed
- Updated @anthropic-ai/claude-agent-sdk from v0.1.31 to v0.1.36 - see [@anthropic-ai/claude-agent-sdk changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md)
