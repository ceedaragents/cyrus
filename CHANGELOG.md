...
- Support for direct assignment of Sentry-created issues
  - Cyrus now processes issues directly assigned by Sentry (without delegation)
  - Automatically detects Sentry issues through attachments, labels, or description patterns
  - Uses the same processing flow as delegated issues for consistent behavior
