...
### Changed
- **Updated `@anthropic-ai/claude-agent-sdk` to v0.2.83 and `@anthropic-ai/sdk` to v0.80.0** - Bumps both Anthropic SDK packages to their latest versions. See [claude-agent-sdk changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md) for details. ([CYPACK-1011](https://linear.app/ceedar/issue/CYPACK-1011), [#1037](https://github.com/ceedaragents/cyrus/pull/1037))
