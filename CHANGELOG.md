...
### Changed
- Updated `@anthropic-ai/claude-agent-sdk` from `0.3.245` to [`0.3.246`](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#03246), adding user-message correlation IDs, model cost-basis reporting, managed model pricing, and per-task stop affordances. `@anthropic-ai/sdk` remains current at [`^0.120.0`](https://github.com/anthropics/anthropic-sdk-typescript/blob/main/CHANGELOG.md#01200-2026-08-19), and the Claude tool allowance lists are unchanged. ([CYPACK-1470](https://linear.app/ceedar/issue/CYPACK-1470/update-anthropic-aiclaude-agent-sdk-and-anthropic-aisdk-to-the-latest), [#1430](https://github.com/cyrusagents/cyrus/pull/1430))
