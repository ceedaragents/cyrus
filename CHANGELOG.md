...
### Fixed
- **OpenCode PR requests no longer block indefinitely after a stalled runner** — Cyrus terminates silent OpenCode processes and advances same-PR requests when a warm session finishes, so later review requests can continue. ([#1263](https://github.com/cyrusagents/cyrus/pull/1263))
