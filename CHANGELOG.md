...
### Added
- **OpenCode SDK integration** - Cyrus now supports the OpenCode SDK as an alternative AI backend. Add the `opencode` label to any Linear issue to process it with OpenCode instead of Claude or Gemini. OpenCode takes highest priority in runner selection, followed by Gemini, then Claude. The integration includes full streaming input support, comprehensive logging, and proper message formatting for Linear activities. ([CYPACK-633](https://linear.app/ceedar/issue/CYPACK-633), [CYPACK-634](https://linear.app/ceedar/issue/CYPACK-634), [CYPACK-635](https://linear.app/ceedar/issue/CYPACK-635), [CYPACK-636](https://linear.app/ceedar/issue/CYPACK-636), [CYPACK-637](https://linear.app/ceedar/issue/CYPACK-637), [CYPACK-638](https://linear.app/ceedar/issue/CYPACK-638), [CYPACK-639](https://linear.app/ceedar/issue/CYPACK-639))
