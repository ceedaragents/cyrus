...
### Changed
- Updated @anthropic-ai/claude-agent-sdk from v0.1.42 to v0.1.49 - brings improvements including Azure AI Foundry support, structured outputs, and synchronization with Claude Code v2.0.49 - see [@anthropic-ai/claude-agent-sdk v0.1.49 changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#0149) (CYPACK-417)
- Updated @anthropic-ai/sdk from v0.69.0 to v0.70.1 - adds Azure Foundry SDK and fixes structured outputs beta header - see [@anthropic-ai/sdk v0.70.1 changelog](https://github.com/anthropics/anthropic-sdk-typescript/blob/main/CHANGELOG.md#0701-2025-11-20) (CYPACK-417)
