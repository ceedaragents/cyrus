...
### Added
- **Slack MCP tools available in agent sessions** - When the `SLACK_BOT_TOKEN` environment variable is set, Slack MCP tools (`mcp__slack`) are now automatically available in all agent sessions, enabling agents to read channels, search messages, and interact with Slack workspaces. ([CYPACK-832](https://linear.app/ceedar/issue/CYPACK-832), [#884](https://github.com/ceedaragents/cyrus/pull/884))
