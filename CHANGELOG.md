...
### Changed
- Updated @anthropic-ai/claude-code from v1.0.112 to v1.0.123 for latest Claude Code improvements. See [Claude Code v1.0.123 changelog](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md#10123)
- Updated @anthropic-ai/sdk from v0.62.0 to v0.63.1 for latest Anthropic SDK improvements
