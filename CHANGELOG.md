...
### Changed
- Updated `@anthropic-ai/claude-agent-sdk` from v0.1.60 to v0.1.62 for latest SDK improvements. See the [official changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md) for details. ([CYPACK-595](https://linear.app/ceedar/issue/CYPACK-595))
