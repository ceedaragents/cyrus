...
### Changed
- Updated `@anthropic-ai/claude-agent-sdk` from 0.2.7 to [0.2.29](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#0229) and `@anthropic-ai/sdk` from 0.71.2 to 0.72.1 ([CYPACK-778](https://linear.app/ceedar/issue/CYPACK-778), [#826](https://github.com/ceedaragents/cyrus/pull/826))
