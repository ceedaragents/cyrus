...
### Changed
- **Updated Claude Agent SDK** - Updated `@anthropic-ai/claude-agent-sdk` from v0.1.72 to v0.1.76 for latest improvements and bug fixes. See the [Claude Agent SDK changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md) for details. ([CYPACK-689](https://linear.app/ceedar/issue/CYPACK-689), [#733](https://github.com/ceedaragents/cyrus/pull/733))
