...
- **`"readOnly"`**: Only tools that read/view content (14 tools)
   - `Read`, `Glob`, `Grep`, `WebFetch`, `WebSearch`, `TodoWrite`, `Task`, `Skill`, `ListMcpResourcesTool`, `ReadMcpResourceTool`, `Monitor`, `TaskOutput`, `EnterPlanMode`, `ExitPlanMode`

- **`"safe"`**: All tools except Bash (29 tools)
...
- **`"all"`**: All available tools including Bash (30 tools)
